...
var Collection = exports.Collection = function () {
    ...
    _createClass(Collection, [{
        ...
        value: function each(callback) {
            ...
            for (var idx = 0; idx < this[_models].length; ++idx) {
                callback(this[_models][idx], idx);
            } // return collection
            return this;
        }
        ...
        value: function fromData(data) {
            return this[_models] = data.map(function (modelData) {
                return new this[_Model](modelData);
            }.bind(this));
        }
...
var RestStorage = exports.RestStorage = function (_Storage) {
    ...
    function RestStorage() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(RestStorage).apply(this, arguments));
    }
    ...
    _createClass(RestStorage, [{
         ...
         *  Fetcth the model
         */
        value: function _fetch(model, params) {

            // get the promise
            var promise = (0, _ajax2.ajax)('GET', model.restPrefix() + model.id());
        ...
        value: function _fetchCollection(collection, parameters) {

            // create a model
            var model = collection.create();

            // get the promise
            var promise = (0, _ajax2.ajax)('GET', model.restPrefix());
        ...
        value: function _update(model) {
            return (0, _ajax2.ajax)('PUT', model.restPrefix() + model.id(), {
                data: model.data
            });
        }
        ...
        value: function _create(model) {
            ...
            // get the promise
            var promise = (0, _ajax2.ajax)('POST', model.restPrefix(), {
                data: model.data
            });
        ...
        key: '_remove',
        value: function _remove(model) {
            return (0, _ajax2.ajax)('DELETE', model.restPrefix() + model.id());
        }
    }]);
...
},{"./Storage":6,"./ajax":9}],4:[function(require,module,exports){
'use strict';
...
var Router = exports.Router = function () {
    ...
    _createClass(Router, [{
        key: 'append',
        value: function append(pattern, callback) {

            // remember the path
            this[_paths].push(new _Route.Route(pattern, callback));
        ...
        value: function init() {
            ...
            console.log('init', window.location.hash.substring(1));

            // we should also make the initial resolve
            this.resolve(window.location.hash.substring(1));
        }
    }]);
...
var Storage = exports.Storage = function () {
    ...
    _createClass(Storage, [{
         ...
         */
        value: function _fetch(model, parameters) {}
    }, {
        key: '_fetchCollection',
        value: function _fetchCollection(collection, parameters) {}
    }, {
        ...
        key: 'store',
        value: function store(models) {

            // are we dealing with single model?
            if (models instanceof _Model.Model) {

                // update or create
                if (models.id() != null) this._update(models);else this._create(models);

                // we are dealing with collection
            } else models.each(function (model) {

                // update or create
                if (model.id() != null) this._update(model);else this._create(model);
            }.bind(this));
        }
        ...
        key: 'fetch',
        value: function fetch(models, parameters) {

            if (models instanceof _Model.Model) return this._fetch(models, parameters);else return this._fetchCollection(models, parameters);
        }
    }]);
...
},{"./Collection":1,"./Model":2}],7:[function(require,module,exports){
'use strict';
...
var View = exports.View = function () {
  ...
  function View(options) {
    ...
    this[_dispatcher] = new _parleJs.Dispatcher();
  }
...
},{"parle-js":310}],8:[function(require,module,exports){
'use strict';
...
var WebStorage = exports.WebStorage = function (_Storage) {
    _inherits(WebStorage, _Storage);
    ...
    function WebStorage(webStorage) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WebStorage).call(this));

        _this[_webStorage] = webStorage;
        return _this;
    }
...
},{"./Storage":6}],9:[function(require,module,exports){
'use strict';
...
Object.defineProperty(exports, 'WebStorage', {
  enumerable: true,
  get: function get() {
    return _WebStorage.WebStorage;
  }
});

var _RestStorage = require('./RestStorage');

Object.defineProperty(exports, 'RestStorage', {
  enumerable: true,
  get: function get() {
    return _RestStorage.RestStorage;
  }
});
...
},{"./Collection":1,"./Model":2,"./RestStorage":3,"./Router":5,"./Storage":6,"./View":7,"./WebStorage":8,"./ajax":9}],11:[function(require,module,exports){
...
},{"_process":315}],12:[function(require,module,exports){
...
var Dispatcher = exports.Dispatcher = function () {
  ...
  _createClass(Dispatcher, [{
    ...
    value: function on(eventName, handler) {
      ...
      if (!this[_signals].hasOwnProperty(eventName)) this[_signals][eventName] = new _Signal.Signal();
    ...
    key: 'trigger',
    value: function trigger(name, event) {
...
},{"./Signal":308,"babel-polyfill":311}],307:[function(require,module,exports){
"use strict";
...
var Event = exports.Event = function () {
  ...
  _createClass(Event, [{
    ...
    key: "shouldPropagate",
    value: function shouldPropagate() {
...
var _SignalBinding = require('./SignalBinding');
...
var Signal = exports.Signal = function () {
    ...
    _createClass(Signal, [{
        ...
        value: function on(handler) {
            ...
            this[_handlers].push(new _SignalBinding.SignalBinding(handler, true));
        ...
        value: function once(handler) {
            // add additional handler
            this[_handlers].push(new _SignalBinding.SignalBinding(handler, false));
...
},{"./SignalBinding":309,"babel-polyfill":311}],309:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SignalBinding = undefined;
...
var SignalBinding = exports.SignalBinding = function () {
   ...
   */
  function SignalBinding(handler, repeat) {
...
},{"babel-polyfill":311}],310:[function(require,module,exports){
'use strict';
...
},{"./Dispatcher":306,"./Event":307,"./Signal":308}],311:[function(require,module,exports){
(function (global){
/* eslint max-len: 0 */
...
},{"babel-regenerator-runtime":11,"babel-runtime/core-js/object/define-property":312,"core-js/fn/regexp/escape":12,"core-js/shim":305}],312:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-property"), __esModule: true };
},{"core-js/library/fn/object/define-property":313}],313:[function(require,module,exports){
var $ = require('../../modules/$');
module.exports = function defineProperty(it, key, desc){
  return $.setDesc(it, key, desc);
};
},{"../../modules/$":314}],314:[function(require,module,exports){
var $Object = Object;
module.exports = {
...
var _allure = require('../../../../lib/allure');
...
var todos = new _allure.Collection(Todo),


// storage = new WebStorage(window.localStorage);
storage = new _allure.RestStorage();

var storagePromise = storage.fetch(todos);

var AddTodo = function (_View) {
    _inherits(AddTodo, _View);

    function AddTodo(data) {
        _classCallCheck(this, AddTodo);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(AddTodo).call(this, data));
    }
...
var List = function (_View2) {
    _inherits(List, _View2);

    function List(data) {
        _classCallCheck(this, List);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(List).call(this, data));
    }
...
var TodoView = function (_View3) {
    _inherits(TodoView, _View3);
